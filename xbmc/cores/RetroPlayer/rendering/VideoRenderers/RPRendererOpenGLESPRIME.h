...
namespace RETRO
{
  ...
  class CRendererFactoryOpenGLESPRIME : public IRendererFactory
  {
  public:
    virtual ~CRendererFactoryOpenGLESPRIME() = default;
  ...
  class CRPRendererOpenGLESPRIME : public CRPBaseRenderer
  {
  public:
    CRPRendererOpenGLESPRIME(const CRenderSettings &renderSettings, CRenderContext &context, std::shared_ptr<IRenderBufferPool> bufferPool);
    ~CRPRendererOpenGLESPRIME() override;
